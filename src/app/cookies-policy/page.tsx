    ...
    <main className="min-h-screen bg-[#0B0F17] text-[#F8FAFC] px-4 py-12">
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        <div className="rounded-2xl border border-white/10 bg-[#131A26] p-6 space-y-4 text-sm leading-relaxed text-[#CBD5E1]">
          ...
          <p>You can control or delete cookies through your browser settings (Chrome: Settings → Privacy → Cookies; Firefox: Settings → Privacy & Security; Safari: Preferences → Privacy). Blocking essential cookies may affect site functionality. To opt out of interest-based advertising, visit <a href="https://www.youronlinechoices.eu" className="text-[#3B82F6] underline">youronlinechoices.eu</a> or <a href="https://optout.aboutads.info" className="text-[#3B82F6] underline">aboutads.info</a>.</p>
          <p>For questions about cookies, contact <a href="/privacy-policy" className="text-[#3B82F6] underline">Privacy Policy</a>.</p>
        </div>
