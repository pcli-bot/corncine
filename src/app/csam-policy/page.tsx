    ...
    <main className="min-h-screen bg-[#0B0E15] text-[#F8FAFC] px-4 py-12">
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        <div className="rounded-2xl border border-white/10 bg-[#151922] p-6 text-sm leading-relaxed text-[#B3B7C1]">
          <p className="text-xs text-[#949AA5]">All performers depicted in adult material referenced by CornCine are represented by the original producers as being 18 years of age or older at the time of creation. See our <a href="/2257" className="text-[#EC69AE] underline">2257 Compliance Statement</a>.</p>
        </div>
