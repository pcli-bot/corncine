    ...
    <main className="min-h-screen bg-[#0B0F17] text-[#F8FAFC] px-4 py-12">
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        <div className="rounded-2xl border border-white/10 bg-[#131A26] p-6 space-y-4 text-sm leading-relaxed text-[#CBD5E1]">
          ...
          <ul className="list-disc list-inside space-y-1 text-[#94A3B8]">
            <li>Email: <a href="mailto:name-roman-aviator@duck.com" className="text-[#3B82F6] underline">name-roman-aviator@duck.com</a> (subject: "CSAM Report")</li>
        ...
        <div className="rounded-2xl border border-white/10 bg-[#131A26] p-6 text-sm leading-relaxed text-[#CBD5E1]">
          <p className="text-xs text-[#64748B]">All performers depicted in adult material referenced by CornCine are represented by the original producers as being 18 years of age or older at the time of creation. See our <a href="/2257" className="text-[#3B82F6] underline">2257 Compliance Statement</a>.</p>
        </div>
