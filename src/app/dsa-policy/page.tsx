    ...
    <main className="min-h-screen bg-[#0B0F17] text-[#F8FAFC] px-4 py-12">
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        <div className="rounded-2xl border border-white/10 bg-[#131A26] p-6 space-y-4 text-sm leading-relaxed text-[#CBD5E1]">
          ...
          <div className="rounded-xl bg-[#0B0F17] border border-white/10 p-4 font-mono text-xs text-[#94A3B8]">
            <p>Email: <a href="mailto:name-roman-aviator@duck.com" className="text-[#3B82F6] underline">name-roman-aviator@duck.com</a></p>
            <p className="mt-1">Languages: English</p>
            <p className="mt-1">Response time: within 48 hours</p>
          </div>
          <p className="text-xs text-[#64748B]">This contact point is for authorities and does not handle general user support or copyright reports — please use the DMCA contact for copyright matters.</p>
        </div>
        <div className="rounded-2xl border border-white/10 bg-[#131A26] p-6 space-y-4 text-sm leading-relaxed text-[#CBD5E1]">
          ...
          <p className="text-xs text-[#64748B]">Annual transparency reports will be published here if required by applicable law.</p>
        </div>
